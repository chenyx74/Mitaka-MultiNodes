...
echo "${DATE_N} ${USER_N} execute $0 [INFO] $@" >>/var/log/openstack-kilo/presystem_compute.log
...
echo -e "\033[41;37m ${DATE_N} ${USER_N} execute $0 [ERROR] $@ \033[0m"  >>/var/log/openstack-kilo/presystem_compute.log
...
if [ -f  /etc/openstack-kilo_tag/presystem_compute.tag ]
then 
...
#finish
echo `date "+%Y-%m-%d %H:%M:%S"` >/etc/openstack-kilo_tag/presystem_compute.tag
echo -e "\033[32m ###################################################### \033[0m"
echo -e "\033[32m ##   compute node system prepare complete successful!#### \033[0m"
echo -e "\033[32m ###################################################### \033[0m"
