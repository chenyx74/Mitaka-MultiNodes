...
echo "${DATE_N} ${USER_N} execute $0 [INFO] $@" >>/var/log/openstack-kilo/presystem_network.log
...
echo -e "\033[41;37m ${DATE_N} ${USER_N} execute $0 [ERROR] $@ \033[0m"  >>/var/log/openstack-kilo/presystem_network.log
...
if [ -f  /etc/openstack-kilo_tag/presystem_network.tag ]
then 
...
#finish
echo `date "+%Y-%m-%d %H:%M:%S"` >/etc/openstack-kilo_tag/presystem_network.tag
echo -e "\033[32m ##################################################### \033[0m"
echo -e "\033[32m ##  network node system prapare complete successful!#### \033[0m"
echo -e "\033[32m ##################################################### \033[0m"
